...
import { PasswordManagerModule } from 'src/shared/modules/password-manager/password-manager.module';
...
import { EmailVerificationModule } from 'src/shared/modules/email-verification/email-verification.module';
